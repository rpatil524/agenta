...
<article key="1" className="col col--6 margin-bottom--lg">
  <CustomDocCard
    item={{
      type: "link",
      href: "/integrations/llm-providers/openai/observability",
      label: "OpenAI",
      description:
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/integrations/llm-providers/litellm/observability",
      label: "LiteLLM",
...
<article key="1" className="col col--6 margin-bottom--lg">
  <CustomDocCard
    item={{
      type: "link",
      href: "/integrations/frameworks/langchain/observability",
      label: "LangChain",
      description:
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/integrations/libraries/instructor/observability",
      label: "Instructor",
...
<article key="1" className="col col--6 margin-bottom--lg">
  <CustomDocCard
    item={{
      type: "link",
      href: "/integrations/frameworks/llamaindex/observability",
      label: "LlamaIndex",
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/integrations/frameworks/langgraph/observability",
      label: "LangGraph",
...
<article key="1" className="col col--6 margin-bottom--lg">
  <CustomDocCard
    item={{
      type: "link",
      href: "/integrations/frameworks/openai-agents/observability",
      label: "OpenAI Agents",
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/integrations/frameworks/pydanticai/observability",
      label: "PydanticAI",
...
<article key="1" className="col col--6 margin-bottom--lg">
  <CustomDocCard
    item={{
      type: "link",
      href: "/integrations/frameworks/dspy/observability",
      label: "DSPy",
  ...
  <CustomDocCard
    item={{
      type: "link",
      href: "/integrations/frameworks/agno/observability",
      label: "Agno",
