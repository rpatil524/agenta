...
export class EventsClient {
    ...
    /**
     * @param {AgentaApi.EventQueryRequest} request
     ...
     *
     * @example
     *     await client.events.queryEventsRpc()
     */
    public queryEventsRpc(
        request: AgentaApi.EventQueryRequest = {},
        requestOptions?: EventsClient.RequestOptions,
    ): core.HttpResponsePromise<AgentaApi.EventsQueryResponse> {
        return core.HttpResponsePromise.fromPromise(this.__queryEventsRpc(request, requestOptions));
    }

    private async __queryEventsRpc(
        request: AgentaApi.EventQueryRequest = {},
        requestOptions?: EventsClient.RequestOptions,
    ): Promise<core.WithRawResponse<AgentaApi.EventsQueryResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as AgentaApi.EventsQueryResponse, rawResponse: _response.rawResponse };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/events/query");
    }
}
