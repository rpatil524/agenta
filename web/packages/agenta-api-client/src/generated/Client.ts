...
import { DeprecatedClient } from "./api/resources/deprecated/client/Client.js";
...
import { OpenTelemetryClient } from "./api/resources/openTelemetry/client/Client.js";
...
export class AgentaApiClient {
    ...
    protected _openTelemetry: OpenTelemetryClient | undefined;
    ...
    protected _deprecated: DeprecatedClient | undefined;
    ...
    public get openTelemetry(): OpenTelemetryClient {
        return (this._openTelemetry ??= new OpenTelemetryClient(this._options));
    }
    ...
    public get deprecated(): DeprecatedClient {
        return (this._deprecated ??= new DeprecatedClient(this._options));
    }
